...
<script>
	function addToCart(){
		$.post("/frontend/addToCart", $("#productListForm").serialize(), function(data) {
			$("#result").html(data);
		});
	}
</script>
		...
		<tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td width="44%"><p>
										...
										<p>
											查询<span class="search-over"> ${searchResultPage.totalCount } </span>结果
										</p></td>
									<td width="48%" align="right" valign="top" style="padding-top: 5px">
									...
									<td width="1%" align="right">
										<img src="${ctx}/image/search/search-03.jpg" width="11" height="80" /></td>
								</tr>
							</table>
						</td>
						<td>&nbsp;</td>
          ...
          <td>&nbsp;</td>
					...
					<tr>
						<td>&nbsp;</td>
						<td>
							<form id="productListForm" action="/frontend/addToCart" method="post">
							<input type="hidden" name="searchStr" value="${searchStr }"/>
							<table width="919" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
									<td height="23"
										style="background-image: url(${ctx}/image/search/search-08.jpg); padding-left: 45px; padding-top: 1px; color: #333; font-size: 10px">
								...
								<tr>
									<td><table width="100%" border="0" cellpadding="3"
											...
											<tr bgcolor="#FFFFFF" align="center">
												...
												<td><a href="/frontend/getProductInfo?productId=${item.id }&shoppingCartId=0"><img src='${item.imageUrl == "" ? "/image/blank.jpg": item.imageUrl}' width="75" height="64" /></a></td>
												<td style="color: #FF6600"><a href="/frontend/getProductInfo?productId=${item.id }&shoppingCartId=0">${item.mfrSku}</a></td>
									...
									<td height="38"
										...
										<table width="100%">
											<tr>
												...
												<% 
													request.setAttribute("pageingUrl", "/frontend/getProductByCategory");
												%>
